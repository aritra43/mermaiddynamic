...
import json
from crewsrstosdd import generate_sdd
load_dotenv()
...
docx_path = "C:\\Users\\l43ar\\Downloads\\mermaiddynamic\\sdd (6).docx"
...
def crew_runner(state:State)->State:
    state["uploaded_srs"]="C:\\Users\\l43ar\\Downloads\\mermaiddynamic\\srs.docx"
    uploaded_srs=state["uploaded_srs"]
    generate_sdd(uploaded_srs=uploaded_srs)
    return state
md_path="C:\\Users\\l43ar\\Downloads\\mermaiddynamic\\srs_sdd.md"
def extract_text_from_md(md_path: str) -> str:
    with open(md_path, "r", encoding="utf-8") as f:
...
workflow.add_edge(START, "crew_runner")
...
final_state = graph.invoke({"appl": application_new})
